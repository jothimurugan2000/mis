frappe.listview_settings['iBeats Data MTD'] = {
    onload: function(listview) {
        ...
        function checkJobStatus(listview) {
            frappe.call({
                method: 'mis.mis.doctype.ibeats_data_to_import.ibeats_data_to_import.rq_mtd_data',
                args: {},
                callback: function (r) {
...
function process_data(listview) {
    ...
    frappe.call({
        method: 'mis.mis.doctype.ibeats_data_to_import.ibeats_data_to_import.enqueue_mtd_data',
        args: {},
        callback: function (r) {
